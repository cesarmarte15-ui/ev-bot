...
def api_dashboard():
    try:
        ...
        logger.info("Dashboard request: sports=%s force=%s", selected_sports, force_refresh)
        ...
        return jsonify({
            "ok": False,
            "error": str(e),
            "sports": {}, "games": [], "top_profit": [],
            "tickets": [], "green": [], "blue": [], "red": []
        }), 500
...
@app.route("/health")
def health():
    return jsonify({"ok": True, "version": "8.2"})
